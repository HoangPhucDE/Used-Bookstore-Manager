...
import com.example.controller.shared.HomeController;
...
public class LoginController {
    ...
    private void openHomeView() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/views/shared/Home.fxml"));
...
private void handleRegisterLink() {
    try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/views/auth/RegisterView.fxml"));
